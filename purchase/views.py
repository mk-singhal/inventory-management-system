...
def purchase(request):
    ...
    if search_purchase:
        purchase_order = PurchaseOrder.objects.filter(Q(name__icontains=search_purchase))
    else:
        # If not searched, return default posts
        purchase_order = PurchaseOrder.objects.all().order_by('created_on')
    
    p = Paginator(purchase_order, 12)  # creating a paginator object
    ...
    return render(request, 'purchase/purchase.html', {'sb':5, 'page_obj':page_obj})
...
#     return render(request, 'purchase/view_seller.html', {'sb':6, 'page_obj':page_obj})
...
#         instance.save()
#         return redirect('purchase:view-seller')
#     return render(request, 'purchase/addSeller.html', {'sb':6})
...
#         return redirect('purchase:view-seller')
#     return render(request, 'purchase/edit_seller.html', {'sb':6, 'seller':seller_instance})
